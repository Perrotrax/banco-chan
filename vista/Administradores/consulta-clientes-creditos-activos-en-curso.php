...
-->
	...
	<head>
		...
		<title>CashMan H.A. | Listado Solicitudes Cr&eacute;ditos Aprobados Activos </title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Cr&eacute;ditos Aprobados</h4>
								</div>
							</div>
						...
						<div class="card-body">
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane fade show active" id="home8" role="tabpanel">
									<div class="pt-4">
										<h4>Solicitudes Cr&eacute;ditos Aprobadas Clientes CashMan H.A</h4><br>
										<p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
														$PrimerNombre = explode(' ', $Nombre, 2);
														print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los clientes que su solicitud de cr&eacute;ditos han sido aprobadas. <strong>Usted podr&aacute; consultar y ver el avence de todas las solicitudes registradas.</strong></p>
											...
											<table style="width: 100%;" id="example5" class="display min-w850">
												...
												<tbody>
													...
													<td><a href="javascript:void()" class="badge badge-rounded badge-primary">$';
														echo number_format($filas['montocredito'], 2);
														echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-info">';
														echo $filas['plazocredito'];
														if ($filas['idproducto'] == 3) {
															echo " a&ntilde;os";
														} else {
															echo " meses";
														}
													...
													<div class="dropdown ml-auto text-right">
														...
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=sistema-pagos-creditos-cashmanha-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="fa fa-money"></i> Pagar Cuotas</a>
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=impresion-estado-cuenta-cuotas-nuevos-creditos&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="fa fa-bank"></i> Estado de Cuenta</a>
														<a class="dropdown-item" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-general-transacciones-procesadas-por-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '"><i class="fa fa-cart-arrow-down"></i> Ver Transacciones</a>';
														if ($filas['estado'] == "cancelado") {
															echo '
															<a data-id="';
															echo $filas['idcreditos'];
															echo '" id="eliminar-solicitud-cliente" style="cursor: help;" class="dropdown-item"><i class="fa fa-trash"></i> Eliminar Solicitud</a>';
														}
														echo '
														</div>
													</div>
    ...
    ***********************************-->
		...
		<script src="<?php echo $UrlGlobal; ?>vista/js/alerta-eliminar-solicitudes-crediticias-clientes.js"></script>
		<!-- Datatable -->
