...
-->
	...
	<head>
		...
		<title>CashMan H.A. | Listado Solicitudes Cr&eacute;ditos Cancelados </title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Cr&eacute;ditos Cancelados</h4>
								</div>
							</div>
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0)">Cr&eacute;ditos Cancelados</a></li>
						</ol>
					</div>
					<div class="row">
						<div class="card-body">
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane fade show active" id="home8" role="tabpanel">
									<div class="pt-4">
										<h4>Solicitudes Cr&eacute;ditos Cancelados Clientes CashMan H.A</h4><br>
										<p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
														$PrimerNombre = explode(' ', $Nombre, 2);
														print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los clientes que su solicitud de cr&eacute;ditos han sido aprobadas y que han finalizado su responsabilidad crediticia con la empresa. <strong>Una vez el cliente cancela su &uacute;ltima cuota, le debe ser entregado el respectivo finiquito en f&iacute;sico en un plazo no mayor a los 7 d&iacute;as de su &uacute;ltimo movimiento.</strong></p>
											...
											<table style="width: 100%;" id="example5" class="display min-w850">
												...
												<tbody>
                                                    ...
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-info">';
														...
														echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-dark">Cancelado</a></td>	
													<td>
                                                    <a target="_blank" style="width: 100%" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=finiquito-cancelacion-creditos-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '&idhistorico=';
														echo $filas['idhistorico'];
														echo '" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-print"></i> Imprimir</a>
												</td>
												<td>
                                                    <a target="_blank" style="width: 100%" href="';
														echo $UrlGlobal;
														echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-solicitudes-creditos-canceladas-historico-clientes&idusuario=';
														echo $filas['idusuarios'];
														echo '&idcredito=';
														echo $filas['idcreditos'];
														echo '" class="btn btn-info shadow btn-xs sharp mr-1"><i class="fa fa-search"></i> Visualizar</a>
												</td>									
												</tr>
													';
													}
