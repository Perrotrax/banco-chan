...
-->
	...
	<head>
		...
		<title>CashMan H.A. | Listado Solicitudes Cr&eacute;ditos Rechazados </title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Cr&eacute;ditos Rechazados</h4>
								</div>
							</div>
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0)">Cr&eacute;ditos Rechazados</a></li>
						</ol>
					</div>
					<div class="row">
						<div class="card-body">
							...
							<div class="tab-content tabcontent-border">
								<div class="tab-pane fade show active" id="home8" role="tabpanel">
									<div class="pt-4">
										<h4>Solicitudes Cr&eacute;ditos Rechazadas Clientes CashMan H.A</h4><br>
										<p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
														$PrimerNombre = explode(' ', $Nombre, 2);
														print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los clientes que su solicitud de cr&eacute;ditos han sido rechazadas. <strong>Es importante enviar al hist&oacute;rico las diferentes solicitudes presentadas ac&aacute;, de lo contrario nuevas solicitudes crediticias no podr&aacute;n ser procesadas si se encuentra a&uacute;n activo un registro en las asignaciones de cr&eacute;ditos principales</strong></p>
											...
											<table style="width: 100%;" id="example5" class="display min-w850">
												...
												<tbody>
													...
													<td><a href="javascript:void()" class="badge badge-rounded badge-danger">';
														...
														echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-danger">Cr&eacute;dito Rechazado</a></td>	
													<td>
													<div class="dropdown ml-auto text-right">
														...
														echo '" id="enviar-solicitudes-historico"><i class="ti-archive"></i> Enviar al Hist&oacute;rico</a>
