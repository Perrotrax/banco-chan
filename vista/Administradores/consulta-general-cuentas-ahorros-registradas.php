...
-->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Consultar Cuentas de Ahorros</h4>
								</div>
							</div>
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0)">Consultar Cuentas Ahorros</a></li>
						</ol>
					</div>
					<div class="row">
						<div class="col-xl-12">
							<div class="card-body">
								...
								<div class="tab-content tabcontent-border">
									<div class="tab-pane fade show active" id="home8" role="tabpanel">
										<div class="pt-4">
											<h4>Consultar, Gestionar Cuentas de Ahorros Clientes CashMan H.A</h4><br>
											<p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
															$PrimerNombre = explode(' ', $Nombre, 2);
															print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todas las cuentas de ahorro registradas. Ac&aacute; podr&aacute;s gestionar, consultar, bloquear, activar, realizar retiros y dep&oacute;sitos en las respectivas cuentas de los clientes<strong> Para filtrar resultados, solamente d&iacute;gita el n&uacute;mero de DUI; o bien el n&uacute;mero de cuenta del cliente en el buscador.</strong></p>
											<div class="table-responsive">
												<table style="width: 100%;" id="example5" class="display min-w850">
													...
													<td><img class="rounded-circle" width="35" src="';
															echo $UrlGlobal;
															echo 'vista/images/phishing.gif" alt=""></td>
													<td>';
															echo $filas['nombres'];
															echo ' ';
                                                    ...
                                                    <td>';
															...
															echo '</td>
													<td>';
															echo $filas['numerocuenta'];
															echo '</td>
                                                    <td> $';
															echo number_format($filas['montocuenta'], 2);
															echo ' USD</td>
													<td><span class="badge light badge-';
															if ($filas['estadocuenta'] == "activa") {
																echo 'success';
															} else if ($filas['estadocuenta'] == "bloqueada") {
																echo 'warning';
															} else if ($filas['estadocuenta'] == "cerrada") {
																echo 'danger';
															}
															echo '">';
															echo ucfirst($filas['estadocuenta']);
															echo '</span></td>
                                                    <td>
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-transacciones-general-cuentas-clientes&idusuariocuenta=';
															echo $filas['idusuarios'];
															echo '"><i class="ti-layout-cta-left"></i> Consultar Cuenta</a>
                                                            <a class="dropdown-item" href="';
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=retiros-cuentas-ahorros-clientes&idusuario=';
															echo $filas['idusuarios'];
															echo '"><i class="ti-wallet"></i> Retirar de Cuenta</a>
                                                            <a class="dropdown-item" href="';
															echo $UrlGlobal;
															echo 'controlador/cGestionesCashman.php?cashmanhagestion=deposito-cuentas-ahorros-clientes&idusuario=';
															echo $filas['idusuarios'];
															echo '"><i class="ti-stats-up"></i> Depositar en Cuenta</a>
														';
															if ($filas['estadocuenta'] == "activa") {
																echo '
															<a style="cursor: pointer;" data-id="';
																echo $filas['idcuentas'];
																echo '" id="bloquear-cuentas-ahorro" class="dropdown-item"><i class="ti-lock"></i> Bloquear Cuenta</a>
																<a style="cursor: pointer;" data-id="';
																echo $filas['idcuentas'];
																echo '" id="cerrar-cuentas-ahorro"  class="dropdown-item"><i class="ti-na"></i> Cerrar Cuenta</a>
															';
															} else if ($filas['estadocuenta'] == "bloqueada") {
																echo '
															<a style="cursor: pointer;" data-id="';
																echo $filas['idcuentas'];
																echo '" id="activar-cuentas-ahorro"  class="dropdown-item"><i class="ti-check"></i> Activar Cuenta</a>
																<a style="cursor: pointer;" data-id="';
																echo $filas['idcuentas'];
																echo '" id="cerrar-cuentas-ahorro"  class="dropdown-item"><i class="ti-na"></i> Cerrar Cuenta</a>
															';
    ...
    ***********************************-->
		...
		<script src="<?php echo $UrlGlobal; ?>vista/js/alerta-bloquear-cuentas-ahorro-clientes.js"></script>
		<script src="<?php echo $UrlGlobal; ?>vista/js/alerta-cerrar-cuentas-ahorro-clientes.js"></script>
		<script src="<?php echo $UrlGlobal; ?>vista/js/alerta-activar-cuentas-ahorro-clientes.js"></script>
		<!-- Datatable -->
