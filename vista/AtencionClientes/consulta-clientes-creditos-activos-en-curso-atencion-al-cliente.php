                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes-atencion-clientes&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=sistema-pagos-creditos-cashmanha-clientes-atencion-al-cliente&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="fa fa-money"></i> Pagar Cuotas</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=impresion-estado-cuenta-cuotas-nuevos-creditos-atencion-al-cliente&idusuario=';
                                                        echo $filas['idusuarios'];
