        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=consulta-listado-cuotas-clientes-morosos">Listado Clientes Morosos</a></li>
                    </ul>
                </li>
                <li <?php if ($_GET['cashmanhagestion'] == "sistema-pagos-creditos-cashmanha-clientes" || $_GET['cashmanhagestion'] == "orden-pago-creditos-cashmanha-clientes") {
                    ...
                    <ul aria-expanded="false">
                        <li><a <?php if ($_GET['cashmanhagestion'] == "sistema-pagos-creditos-cashmanha-clientes") {
                                    echo 'class="active-element-menu"';
                                } ?> href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=listado-general-creditos-aprobados-activos">Listado de Clientes</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                    ...
                    <ul aria-expanded="false">
                        ...
                        ?>
                            <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=consulta-general-mis-transacciones-procesadas-clientes">Mis Transacciones</a></li>
                        <?php } ?>
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=listado-general-creditos-aprobados-activos">Transacciones Por Cliente</a></li>
                    </ul>
                </li>
                <?php
                if ($_SESSION['comprobacioncuenta_ahorros'] == "si") {
                    ...
                    <li <?php if ($_GET['cashmanhagestion'] == "sistema-pagos-creditos-cashmanha-clientes" || $_GET['cashmanhagestion'] == "validacion-datos-transferencia-otras-cuentas-clientes") {
                        ...
                        <ul aria-expanded="false">
                            <li><a <?php if ($_GET['cashmanhagestion'] == "validacion-datos-transferencia-otras-cuentas-clientes") {
                                        echo 'class="active-element-menu"';
                                    } ?> href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=transferencia-otras-cuentas-clientes">Transferir Dinero Otras Cuentas</a></li>
                        </ul>
                    </li>
                <?php } ?>
                <li <?php if ($_GET['cashmanhagestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=registrar-ticket-problema-plataforma">Registrar Reportes Problemas</a></li>
                        <li><a <?php if ($_GET['cashmanhagestion'] == "consulta-especifica-tickets-reportes-plataforma") {
                                    echo 'class="active-element-menu"';
                                } ?> href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=consulta-listado-tickets-reportes-plataforma">Listado Reportes Problemas</a></li>
                    </ul>
                </li>
                <li <?php if ($_GET['cashmanhagestion'] == "detalle-mensajeria-cashmanha-usuarios") {
                    ...
                    <ul aria-expanded="false">
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha">Enviar Nuevo Mensaje</a></li>
                        <li><a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=mensajeria-cashmanha-usuarios">Bandeja de Entrada</a></li>
                ...
                <li><a class="ai-icon" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=visualizar-mis-notificaciones-usuarios" aria-expanded="true">
                        <svg fill="LightSlateGrey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            <path fill="none" d="M0 0h24v24H0z" />
            ...
            <div class="add-menu-sidebar">
                ...
                <p style="font-size: .6rem;">Desarrollo por <i class="fa fa-heart"></i> <a style="color: #fff;" href="https://github.com/Perrotrax">dieguin-chan and ianLOL</a></p>
