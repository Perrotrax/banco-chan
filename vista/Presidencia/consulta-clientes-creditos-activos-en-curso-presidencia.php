                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Cr&eacute;ditos Aprobados [En Curso]</h4>
                                </div>
                            </div>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-solicitudes-creditos-aprobadas-activas-clientes-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti-help-alt"></i> Ver Informaci&oacute;n</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=impresion-estado-cuenta-cuotas-nuevos-creditos-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="fa fa-bank"></i> Estado de Cuenta</a>
														<a class="dropdown-item" href="';
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-general-transacciones-procesadas-por-clientes-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
