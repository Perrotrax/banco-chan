...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Listado Solicitudes Cr&eacute;ditos Reestructuraci&oacute;n </title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Reestructuraci&oacute;n Cr&eacute;ditos</h4>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Reestructurar Solicitudes Cr&eacute;ditos Clientes CashMan H.A</h4><br>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<td><a href="javascript:void()" class="badge badge-rounded badge-danger">';
                                                        ...
                                                        echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-warning">Necesita Reestructurarse</a></td>	
													<td>
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=reestructuracion-solicitudes-creditos-clientes-presidencia&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti-eye"></i> Reestructurar Solicitud de Cr&eacute;dito</a>
