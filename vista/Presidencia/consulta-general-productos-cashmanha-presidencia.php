...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Consulta General de Productos</title>
        <!-- Favicon icon -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos CashMan H.A</h4><br>
                                                ...
                                                <div class="table-responsive">
													...
													<td><img class="rounded-circle" width="35" src="';
                                                                echo $UrlGlobal;
                                                                echo 'vista/images/shopping.gif" alt=""></td>
													<td>';
                                                                echo $filas['codigo'];
                                                                echo '</td>
													<td>';
                                                                ...
                                                                echo '</td>
													<td>';
                                                                echo $filas['descripcionproducto'];
                                                                echo '</td>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-productos-especifica-cashmanha-presidencia&idproducto=';
                                                                echo $filas['idproducto'];
                                                                echo '"><i class="ti-eye"></i> Ver Producto</a>
															<a class="dropdown-item" href="';
                                                                echo $UrlGlobal;
                                                                echo 'controlador/cGestionesCashman.php?cashmanhagestion=modificar-productos-cashmanha-presidencia&idproducto=';
                                                                echo $filas['idproducto'];
                                                                echo '"><i class="ti-pencil-alt2"></i> Modificar Producto</a>
															<a style="cursor: pointer;" data-id="';
                                                                echo $filas['idproducto'];
                                                                echo '" id="desactivar-productos" class="dropdown-item"><i class="ti-unlink"></i> Desactivar Producto</a>
                                                            <a style="cursor: pointer;" data-id="';
                                                                echo $filas['idproducto'];
                                                                echo '" id="expirar-productos" class="dropdown-item"><i class="ti-na"></i> Expirar Producto</a>
														</div>
													</div>
												</td>									
												</tr>
                                        ...
                                        <div class="tab-pane fade" id="profile8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Inactivos CashMan H.A</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                                ...
                                                <div class="col-lg-12 mb-2">
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
                                                                    echo $UrlGlobal;
                                                                    echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-productos-especifica-cashmanha&idproducto=';
                                                                    echo $filas['idproducto'];
                                                                    echo '"><i class="ti-eye"></i> Ver Producto</a>
															<a class="dropdown-item" href="';
                                                                    echo $UrlGlobal;
                                                                    echo 'controlador/cGestionesCashman.php?cashmanhagestion=modificar-productos-cashmanha&idproducto=';
                                                                    echo $filas['idproducto'];
                                                                    echo '"><i class="ti-pencil-alt2"></i> Modificar Producto</a>
															<a style="cursor: pointer;" data-id="';
                                                                    echo $filas['idproducto'];
                                                                    echo '" id="activar-productos" class="dropdown-item"><i class="ti-unlink"></i> Activar Producto</a>
														</div>
													</div>
												</td>									
												</tr>
                                        ...
                                        <div class="tab-pane fade" id="profile9" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Consultar, Gestionar Productos Expirados CashMan H.A</h4><br>
                                                <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                $PrimerNombre = explode(' ', $Nombre, 2);
                                                ...
                                                <div class="col-xl-12">
													...
													<td>';
                                                                    echo $filas['descripcionproducto'];
                                                                    echo '</td>
                                                    <td><a href="javascript:void()" class="badge badge-rounded badge-danger">Expirado</a></td>	
													<td>
													<div class="dropdown ml-auto text-right">
														<div class="btn-link" data-toggle="dropdown">
															<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
