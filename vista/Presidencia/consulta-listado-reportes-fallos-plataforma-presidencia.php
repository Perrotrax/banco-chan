...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Listado Clientes Morosos </title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Listado Reportes Fallos Plataforma</h4>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Listado Reportes de Fallos - Plataforma CashMan H.A</h4><br>
                                        <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                        print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los reportes de fallos registrados por todos los usuarios / clientes de esta plataforma. Podr&aacute;s gestionarlos y darles seguimiento hasta solventar la problem&aacute;tica planteada en ellos.</strong></p>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td><span class="badge badge-rounded badge-primary">';
                                                        echo $filas['idreporte'];
                                                        echo '</span></td>
                                                    <td>';
                                                        echo $filas['nombrereporte'];
                                                        echo '</td>
													<td>';
                                                        echo $filas['descripcionreporte'];
                                                        echo '</td>
                                                    <td><span class="badge badge-rounded badge-light">';
                                                        echo $filas['fecharegistroreporte'];
                                                        echo '</span></td>
                                                    <td><span class="badge badge-rounded ';
                                                        if ($filas['estado'] == "pendiente") {
                                                            echo 'badge-danger';
                                                        } else if ($filas['estado'] == "en proceso") {
                                                            echo 'badge-warning';
                                                        } else if ($filas['estado'] == "no resuelto") {
                                                            echo 'badge-danger';
                                                        } else if ($filas['estado'] == "resuelto") {
                                                            echo 'badge-success';
                                                        } else if ($filas['estado'] == "cerrado") {
                                                            echo 'badge-dark';
                                                        }
                                                        echo '">';
                                                        echo $filas['estado'];
													...
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=consulta-especifica-tickets-reportes-plataforma&idreporte=';
                                                        echo $filas['idreporte'];
                                                        echo '"> <i class="ti-help-alt"></i> Ver Reporte</a><br>
														</div>
													</div>
												</td>									
												</tr>
