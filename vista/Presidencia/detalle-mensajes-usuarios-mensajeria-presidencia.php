...
-->
	...
	<head>
		...
		<title>CashMan H.A. | Inbox CashMan H.A </title>
		<!-- Favicon icon -->
				...
				<div class="container-fluid">
					<div class="page-titles">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="javascript:void(0)">Mensajer&iacute;a</a></li>
							<li class="breadcrumb-item active"><a href="javascript:void(0)">Detalles Mensajes</a></li>
						</ol>
					</div>
					<!-- row -->
					<div class="row">
							...
							<div class="card">
								<div class="card-body">
									<div class="email-left-box generic-width px-0 mb-5">
										<div class="p-0">
											<a href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=envio-mensajeria-usuarios-cashmanha-presidencia" class="btn btn-primary btn-block">Enviar Nuevo Mensaje</a>
										</div>
										<div class="mail-list mt-4">
											<a href="email-inbox.html" class="list-group-item"><i class="fa fa-inbox font-18 align-middle mr-2"></i> Recibidos <span class="badge badge-primary badge-sm float-right"><?php echo NumeroMensajesRecibidosUsuarios_Secundario($conectarsistema1, $_SESSION['id_usuario']); ?></span> </a>
										</div>
									</div>
									<div class="email-right-box ml-0 ml-sm-4 ml-sm-0">
										...
										<div class="read-content">
											<div class="media pt-3">
												<img class="mr-2 rounded" width="50" alt="image" src="<?php echo $UrlGlobal; ?>/vista/images/fotoperfil/<?php echo $Gestiones->getFotoUsuarios(); ?>">
												<div class="media-body mr-2">
													<h5 class="text-primary mb-0 mt-1"><?php echo $Gestiones->getNombresUsuarios(); ?> <?php echo $Gestiones->getApellidosUsuarios(); ?></h5>
													<p class="mb-0"><?php $FechaEnvioMensaje = date_create($Gestiones->getFechaMensajeria());
																	echo date_format($FechaEnvioMensaje, "d-m-Y"); ?></p>
												</div>
												<a data-id="<?php echo $Gestiones->getIdMensajeria(); ?>" id="ocultar-mensajes" class="btn btn-primary px-3 light ml-2"><i class="fa fa-trash"></i> Ocultar de mi lista</a>
											</div>
											<hr>
											<div class="media mb-2 mt-3">
												<div class="media-body"><span class="pull-right"><?php $FechaEnvioMensaje = date_create($Gestiones->getFechaMensajeria());
																									echo date_format($FechaEnvioMensaje, "H:i:s"); ?></span>
													<h5 class="my-1 text-primary"><?php echo $Gestiones->getNombreMensajeria(); ?></h5>
													<p class="read-content-email">
														Para: <strong>M&iacute;</strong>, de: <strong><?php echo $Gestiones->getCodigoUsuarios(); ?></strong></p>
												</div>
											</div>
											<div class="read-content-body">
												<h5 class="mb-4">Asunto: <?php echo $Gestiones->getAsuntoMensajeria(); ?></h5>
												<p class="mb-2"><?php echo $Gestiones->getDetalleMensajeria(); ?></p>

												<h5 class="pt-3"><?php echo $Gestiones->getNombresUsuarios(); ?> <?php echo $Gestiones->getApellidosUsuarios(); ?></h5>
												<p>Atentamente</p>
												<hr>
											</div>
										</div>
    ...
    ***********************************-->
		...
		<script src="<?php echo $UrlGlobal; ?>vista/js/alerta-ocultar-mensajes-recibidos-mensajeria-interna.js"></script>
		<!-- Datatable -->
