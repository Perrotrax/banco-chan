...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Gestionar Nuevos Cr&eacute;ditos</title>
        <!-- Favicon icon -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                    <div class="pt-4">
                                        <h4>Consulta Solicitudes Cr&eacute;ditos Aprobadas Clientes CashMan H.A</h4><br>
                                        <p>Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                        print_r($PrimerNombre[0]); ?>, en este apartado encontrar&aacute;s el listado completo de todos los usuarios los cuales ingresaron una nueva solicitud de cr&eacute;ditos, se gestionaron y han sido aprobadas. Ac&aacute; podr&aacute;s generar las cuotas mensuales seg&uacute;n el cliente solicito y el contrato final que deber&aacute; ser entregado al mismo. <strong>Este procedimiento debe realizarse en presencia del cliente.</strong></p>
                                            ...
                                            <table style="width: 100%;" id="example5" class="display min-w850">
                                                ...
                                                <tbody>
													...
													<td><a href="javascript:void()" class="badge badge-circle badge-outline-info">';
                                                        echo $filas['nit'];
                                                        echo '</a></td>
                                                    <td><a href="javascript:void()" class="badge badge-circle badge-outline-success">';
                                                        echo $filas['estado'];
                                                        echo '</a></td>
                                                    <td>
													<div class="dropdown ml-auto text-right">
                                                        ...
                                                        echo $UrlGlobal;
                                                        echo 'controlador/cGestionesCashman.php?cashmanhagestion=gestionador-cuotas-contratos-solicitudes-creditos-clientes&idusuario=';
                                                        echo $filas['idusuarios'];
                                                        echo '"><i class="ti ti-wallet"></i> Generar Cuotas y Contrato Cliente</a>
														</div>
													</div>
												</td>									
												</tr>
