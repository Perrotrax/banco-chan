								...
								<div class="card-body">
									...
									<div class="tab-content tabcontent-border">
										<div class="tab-pane fade show active" id="home8" role="tabpanel">
											<div class="pt-4">
												<h4>Consulta Asignaci&oacute;n Nuevos Cr&eacute;ditos Clientes CashMan H.A</h4><br>
													...
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a target="_blank" class="dropdown-item" href="';
																echo $UrlGlobal;
																echo 'controlador/cGestionesCashman.php?cashmanhagestion=segunda-revision-gestionar-solicitudes-creditos-clientes-presidencia&idusuario=';
