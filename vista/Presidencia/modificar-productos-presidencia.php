...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Modificar Producto <?php echo $Gestiones->getNombreProductos(); ?></title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Modificar Productos</h4>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Modificar Productos - CashMan H.A</h4><br>
                                                    ...
                                                    <div class="row form-validation">
                                                        <div class="col-lg-6 mb-2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <input style="cursor: no-drop;" type="text" class="form-control" id="val-codigoproducto" name="val-codigoproducto" placeholder="Ingrese el c&oacute;digo &uacute;nico del producto" onBlur="comprobarCodigoProductos()" value="<?php echo $Gestiones->getCodigoProductos(); ?>" readonly>
                                                                    <div class="col-md-12">
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-modificar-productos-cashmanha.js"></script>
