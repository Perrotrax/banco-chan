...
-->
	...
	<head>
		...
		<title>CashMan H.A. | Mis Notificaciones </title>
		<!-- Favicon icon -->
						...
						<div class="collapse navbar-collapse justify-content-between">
							<div class="header-left">
								<div class="dashboard_bar">
									<h4 style="font-weight: 600;">Mis Notificaciones</h4>
								</div>
							</div>
							...
							<ul class="navbar-nav header-right">
								...
								<li class="nav-item dropdown notification_dropdown">
									...
									*/
									...
									?>
									<span style="font-size: .6rem" class="badge light text-light bg-primary"><?php echo number_format($data->main->temp, 1) ?>°C</span>
								</li>
