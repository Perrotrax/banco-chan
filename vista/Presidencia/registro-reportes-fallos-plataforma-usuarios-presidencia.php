...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Registro Fallos Plataforma</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Registrar Fallos Plataforma</h4>
                                </div>
                            </div>
                            ...
                            <ul class="navbar-nav header-right">
                                <li class="nav-item dropdown notification_dropdown">
                                    <a class="nav-link  ai-icon" href="#" role="button" data-toggle="dropdown">
                                        ...
                                        <span class="badge light text-white bg-primary"><?php echo NumeroNotificacionesRecibidasUsuarios($conectarsistema1, $_SESSION['id_usuario']); ?></span>
                                    </a>
                                ...
                                <li class="nav-item dropdown notification_dropdown">
                                    <a class="nav-link bell bell-link" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=mensajeria-cashmanha-usuarios-presidencia">
                                        ...
                                        <span class="badge light text-white bg-primary"><?php echo NumeroMensajesRecibidosUsuarios($conectarsistema2, $_SESSION['id_usuario']); ?></span>
                                    </a>
                                </li>
                                <li class="nav-item dropdown notification_dropdown">
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Registrar Reportes Problemas</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                                    ...
                                    <div id="with-icon_collapseOne" class="accordion__body collapse" data-parent="#accordion-six">
                                        <div class="accordion__body--text">
                                            <i class="ti-direction"></i> Estimado(a) <?php $Nombre = $_SESSION['nombre_usuario'];
                                                                                        $PrimerNombre = explode(' ', $Nombre, 2);
                                                                                        print_r($PrimerNombre[0]); ?>, usted podr&aacute; registrar los diferentes problemas e inestabilidades que esta plataforma presenta, por favor sea claro y conciso en el registro de su ticket. El equipo de soporte t&eacute;nico tratar&aacute; de resolver el problema ingresado lo m&aacute;s pronto posible, y una vez solventado, le ser&aacute; enviado en su pesta&ntilde;a de notificaciones que el reporte ha sido resuelto.</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane fade show active" id="home8" role="tabpanel">
                                            <div class="pt-4">
                                                <h4>Registrar Ticket de Fallos Plataforma - CashMan H.A</h4>
                                                <br>
                                                <form id="ingreso-nuevos-reportesfallos" class="validacion-registro-ticket-problemas" method="post" autocomplete="off" enctype="multipart/form-data">
                                                    <div class="row form-validation">
                                                        <div class="col-lg-6 mb-2">
                                                            <div class="form-group">
                                                                <label class="text-label">Nombre de Ticket Reporte <span class="text-danger">*</span></label>
                                                                <div class="col-lg-12">
                                                                    <input type="text" class="form-control" id="val-nombrereporte" name="val-nombrereporte" placeholder="Ingrese el nombre del ticket del reporte">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 mb-2">
                                                            <div class="form-group">
                                                                <label class="text-label">Fecha de Ticket Reporte <span class="text-danger">*</span></label>
                                                                <div class="col-lg-12">
                                                                    <input style="cursor: no-drop;" type="text" class="form-control" value="<?php echo date('d-m-Y h:i:s'); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <textarea class="form-control" placeholder="Ingrese la descripci&oacute;n completa de su ticket de reporte" id="val-descripcion-reporte" name="val-descripcion-reporte" rows="5"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <code>Estimado(a) usuario, para una mejor resoluci&oacute;n, es obligatorio subir la captura de pantalla presentando el problema descrito en este ticket.</code><br><br>
                                                                    <input type="file" name="fotoreporteproblema" id="fotoreporteproblema" class="dropify" data-max-file-size="10M" accept="image/x-png,image/jpeg,image/jpg,image/gif" data-allowed-file-extensions='["png", "jpeg","jpg","gif"]' required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- ENVIO DATOS -->
                                                    <button type="submit" class="btn btn-rounded btn-primary"><span class="btn-icon-left text-primary"><i class="ti-stats-up"></i></span>Registrar Ticket de Fallos</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-ingreso-reportes-fallos-plataforma.js"></script>
        <!-- Datatable -->
