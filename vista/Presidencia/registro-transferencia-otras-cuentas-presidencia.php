...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Transferencias Otras Cuentas</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Transferencias Otras Cuentas</h4>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card overflow-hidden">
                                <div class="text-center p-5 overlay-box">
                                    ...
                                    <h5 class="mt-3 mb-0 text-white">Detalles de mi cuenta</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="bgl-primary rounded p-3">
                                                <h4 class="mb-0 text-danger"><?php echo $Gestiones->getNumeroCuentaAhorroClientes(); ?></h4>
                                ...
                                <div class="col-xl-12">
                                    <div class="alert alert-primary left-icon-big alert-dismissible fade show">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-1 mb-2">¡Bienvenido(a) a nuestro sistema de tranferencias a otras cuentas!</h6>
                                                <p class="mb-0"><i class="mdi mdi-account-alert"></i> Antes de empezar, le recordamos que debe contar con saldo suficiente para transferir a otras cuentas, adem&aacute;s de verificar que los datos sean correctos a la cuenta de destino final antes de procesar los datos<br><br><i class="mdi mdi-account-alert"></i> Por favor no actualizar la p&aacute;gina una vez usted hace la respectiva validaci&oacute;n del n&uacute;mero de cuenta del cliente. <strong>Caso contrario, por seguridad deber&aacute; de validar nuevamente el n&uacute;mero de cuenta.</strong><br><br> <i class="mdi mdi-account-alert"></i> S&iacute; usted no ingresa el c&oacute;digo de seguridad que le ha sido enviado a su correo, no podr&aacute; completar la transferencia.</p>
                                            </div>
                                        </div>
                                    </div><br>
                                    <form action="../controlador/cGestionesCashman.php?cashmanhagestion=validacion-datos-transferencia-otras-cuentas-clientes-presidencia" class="form-valide" method="POST" autocomplete="off">
                                        <div class="form-group">
                                            <label class="text-label">Por favor ingrese el n&uacute;mero de cuenta del cliente a transferir <span class="text-danger">*</span></label>
                                            <small>Debe contener 9 d&iacute;gitos</small>
                                            <div class="input-group">
                                                <input style="letter-spacing: 1.1rem;" type="text" class="form-control" id="val-numerocuentaclientes" name="val-numerocuentaclientes" placeholder="Ej: 102212121" onBlur="comprobarCuentasClientes()" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" maxlength="9">
                                            </div>
                                            <div class="col-md-12">
                                                <span id="estadousuariocuenta"></span>
                                            </div>
    ...
    ***********************************-->
                ...
                <script src="<?php echo $UrlGlobal; ?>vista/js/ComprobarExistenciasCuentasClientes_Transferencias.js"></script>
                <!-- Datatable -->
