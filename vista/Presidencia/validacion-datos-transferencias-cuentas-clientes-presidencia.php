...
// NO MOSTRAR PAGINA SI NO EXISTE REFERENCIA DE CUENTA DESTINATARIA
if (empty($Gestiones->getNumeroCuentaAhorroClientesTransferencias())) {
...
-->
    ...
    <head>
        ...
        <title>CashMan H.A. | Consultar Mi Cuenta de Ahorro</title>
        <!-- Favicon icon -->
                        ...
                        <div class="collapse navbar-collapse justify-content-between">
                            <div class="header-left">
                                <div class="dashboard_bar">
                                    <h4 style="font-weight: 600;">Validaci&oacute;n Transferencias Otras Cuentas</h4>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card overflow-hidden">
                                <div class="text-center p-5 overlay-box">
                                    ...
                                    <h5 class="mt-3 mb-0 text-white">Transferencias Otras Cuentas</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="bgl-primary rounded p-3">
                                                <h4 class="mb-0 text-danger"><?php echo $Gestiones->getNumeroCuentaAhorroClientesTransferencias(); ?></h4>
                                                <small>N&uacute;mero de Cuenta Transferencia</small>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="bgl-primary rounded p-3">
                                ...
                                <div class="col-xl-12">
                                    <div class="alert alert-primary left-icon-big alert-dismissible fade show">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-1 mb-2">Datos del Cliente a Transferir:</h6>
                                                <p class="mb-0"><i class="mdi mdi-account-alert"></i> Nombre Completo del Cliente: <?php echo $Gestiones->getNombresClienteCuentaAhorroClientesTransferencias() ?> <?php echo $Gestiones->getApellidosClienteCuentaAhorroClientesTransferencias() ?><br><i class="mdi mdi-account-alert"></i> N&uacute;mero de Cuenta del Cliente: <?php echo $Gestiones->getNumeroCuentaAhorroClientesTransferencias(); ?><br><br><i class="mdi mdi-message-alert"></i> ¿Los datos del cliente son correctos? S&iacute; todo esta correcto, por favor genere su c&oacute;digo de seguridad para procesar esta transferencia y rev&iacute;se su correo. Posteriormenta ingrese el monto a transferir. <strong>Cuenta con 2 minutos para validar el respectivo c&oacute;digo de seguridad.</strong></p>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div style="margin:0; padding:0;" id="resultados_ajax"></div>
                                    <div class="col-xl-12 col-lg-12 col-sm-12" id="mensaje-codigo-usuarios">
                                        <div class="widget-stat card bg-info">
                                            <div class="card-body  p-4">
                                                <div class="media">
                                                    <span class="mr-3">
                                                        <img style="width: 100%; max-width: 100px;" class="img-fluid" src="<?php echo $UrlGlobal; ?>vista/images/alert.gif">
                                                    </span>
                                                    <div class="media-body text-light text-right">
                                                        <p class="mb-1">¡Alto! Antes de continuar, debe generar su respectivo c&oacute;digo de seguridad</p>
                                                        <button id="registro-nuevos-codigos-transferencias-clientes" type="button" class="btn light btn-success">Generar Nuevo C&oacute;digo de Seguridad</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <form id="transferir-otras-cuentas-clientes" name="calculadora" class="form-valide" method="POST" autocomplete="off">
                                        <div style="margin:0; padding:0;" id="resultados_transferencias"></div>
                                        <input type="hidden" name="IdCuentaDestinoClientes" value="<?php echo $Gestiones->getIdTransaccionesDepositosRetirosCuentasTransferencias(); ?>">
                                        <input type="hidden" name="NumeroCuentaDestinoClientes" value="<?php echo $Gestiones->getNumeroCuentaAhorroClientesTransferencias(); ?>">
                                        <input type="hidden" name="IdCuentaEnvioClientes" value="<?php echo $Gestiones->getIdCuentaAhorroClientes(); ?>">
                                        <input type="hidden" name="IdUsuarioDestinoClientes" value="<?php echo $Gestiones->getIdCuentaAhorroTransferenciaDestinoClientes(); ?>">
                                        <input type="hidden" name="SaldoActualCuentaClientes" id="val-saldoactualclientescuentas" onKeyUp="CalcularNuevoSaldoCliente()" value="<?php echo $Gestiones->getSaldoCuentaAhorroClientes(); ?>">
                                        <input style="border: 0; width: 6em;" type="hidden" name="resultado" id="val-resultadotransaccion" onInput="ValidarSaldoRetiroClientes()" value="<?php echo $Gestiones->getSaldoCuentaAhorroClientes(); ?>">
                                        <div class="form-group">
                                            <label class="text-label">Por favor ingrese el c&oacute;digo de seguridad <span class="text-danger">*</span></label>
                                            <small>Rev&iacute;se su correo, debe contener 6 d&iacute;gitos</small>
                                            <div class="input-group">
                                                <input style="letter-spacing: 1.1rem;" type="text" class="form-control" id="val-codigoseguridadtransferencia" name="val-codigoseguridadtransferencia" placeholder="Ej: 1120945" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" maxlength="11" onblur="comprobarCodigoSeguridadTransferencias()" required>
                                            </div>
                                            <div class="col-md-12">
                                                <span id="estado_codigoseguridad_transferencias"></span>
                                            </div>
    ...
    ***********************************-->
        ...
        <script src="<?php echo $UrlGlobal; ?>vista/js/ingreso-codigos-seguridad-transferencias-clientes.js"></script>
        <script src="<?php echo $UrlGlobal; ?>vista/js/ComprobarCodigoSeguridadTransferencias.js"></script>
        <script src="<?php echo $UrlGlobal; ?>vista/js/procesamiento-transferencias-cuentas-clientes.js"></script>
        <!-- Datatable -->
        ...
        <script>
            ...
            function CalcularNuevoSaldoCliente() {
                ...
                var SaldoRetiroCuentaClientes = document.calculadora.SaldoTransferenciasCuentasClientes.value;
                try {
                    // INICIALIZACION DE VARIABLES GLOBALES
                    SaldoActualCuentaClientes = (isNaN(parseFloat(SaldoActualCuentaClientes))) ? 0 : parseFloat(SaldoActualCuentaClientes);
                    SaldoRetiroCuentaClientes = (isNaN(parseFloat(SaldoRetiroCuentaClientes))) ? 0 : parseFloat(SaldoRetiroCuentaClientes);
                    // CALCULO NUEVO SALDO FINAL CLIENTES
                    CalcularNuevoSaldoClientes = SaldoActualCuentaClientes - SaldoRetiroCuentaClientes;
                    // IMPRESION DE RESULTADO
                    if (CalcularNuevoSaldoClientes < 0) {
                        Saldo = 0;
                        document.calculadora.resultado.value = Saldo.toFixed(2);
                    } else {
