                ...
                <div class="col-md-6">
                    <div class="alert alert-success left-icon-big alert-dismissible fade show"">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0">Su solicitud de restablecimiento de su cuenta ha sido procesada con &eacute;xito. Por favor revise su correo y siga las instrucciones ah&iacute; descritas. <br> <br>¿Problemas? por favor comun&iacute;quese al siguiente correo: <a href="mailto:diego.izahel@gmail.com">diego.izahel@gmail.com</a> Nuestro equipo de soporte t&eacute;cnico se comunicar&aacute; con usted en el menor tiempo posible.<br><br>Atentamente: Equipo de recuperaciones de cuentas - CashMan H.A.<strong></strong></p>
                        </div>
                    </div>
                </div>
            </div>
