                ...
                <div class="col-md-6">
                    <div class="alert alert-danger left-icon-big alert-dismissible fade show"">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0">Lo sentimos, pero la petici&oacute;n de cambio de contrase&ntilde;a ha fallado. Por favor comun&iacute;quese al siguiente correo: <a href="mailto:soporte@cashmanha.com">soporte@cashmanha.com</a> Nuestro equipo de soporte t&eacute;cnico se comunicar&aacute; con usted en el menor tiempo posible.<br><br>Atentamente: Equipo de recuperaciones de cuentas - CashMan H.A.<strong></strong></p>
                        </div>
                    </div>
                </div>
                <a class="btn btn-primary btn-block" href="<?php echo $UrlGlobal; ?>controlador/cIniciosSesionesUsuarios.php?cashmanha=iniciarsesion">Regresar al inicio</a>
            </div>
        </div>
    </div>
    </div>
