...
<head>
    ...
    <title>CashMan H.A. | Error 404</title>
    <!-- Favicon icon -->
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-5">
                    <div class="form-input-content text-center error-page">
                        ...
                        <div>
                            <a class="btn btn-primary" href="<?php echo $UrlGlobal; ?>controlador/cGestionesCashman.php?cashmanhagestion=redirecciones-sistema-cashmanha">Regresar Al Inicio De Mi Portal</a>
                        </div>
                    </div>
                </div>
            </div>
