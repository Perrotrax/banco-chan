...
-->
        ...
        <head>
            ...
            <title>CashMan H.A. | Gestor Nuevos Pr&eacute;stamos Hipotecarios</title>
            <!-- Favicon icon -->
                                ...
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <h3 class="text-center mb-4">Gestor de Pr&eacute;stamos Hipotecarios</h3>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <p>Asignar Nuevo Pr&eacute;stamo Hipotecario</p>
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn light btn-secondary" data-toggle="modal" data-target="#prestamospersonales">Requisitos Pr&eacute;stamos Hipotecarios</button>
                                                        <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <h4 class="text-primary mb-4">Pr&eacute;stamos Hipotecarios</h4>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-tag"></i> Ingreso m&iacute;nimo: $800.00 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Tasa de inter&eacute;s desde el 1.05% mensual</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&iacute;nimo a financiar $30,000.00 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&aacute;ximo a financiar 90% valor vivienda</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Plazo m&aacute;ximo 20 a&ntilde;os</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-tag"></i> Ingreso m&iacute;nimo: $1,000.00 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Tasa de inter&eacute;s desde el 2.20% mensual</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&iacute;nimo a financiar $35,000.00 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&aacute;ximo a financiar 90% valor vivienda</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Plazo m&aacute;ximo 15 a&ntilde;os</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Todos nuestros cr&eacute;ditos cuentan con cuota seguro contra da&ntilde;os, y seguro de deuda</h6>
                                                                    </div>
                                    ...
                                    */
                                                        ...
                                                        ?>
                                                            <div class="col-xl-12">
                                                                <form data-id="<?php echo $Gestiones->getIdUsuarios(); ?>" id="ingreso-datos-credito-clientes" class="validacion-registro-credito-personal" name="formulariocreditosclienteshipotecas" method="post" autocomplete="off" enctype="multipart/form-data" onkeyup="ConsultarRequisitosPrestamosHipotecarios()">
                                                                    ...
                                                                    ';
                                                                        ...
                                                                        <div class="col-lg-12 mb-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    ...
                                                                                    <input type="range" class="form-control" value="3" min="1.05" max="12" autocomplete="off" id="rangointereses" name="rangointereses" onKeyUp="CalculoCuotaMensualHipotecas()" step="0.05">
                                                                        ...
                                                                        <div class="col-lg-6 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="text-label">Valor de Inmueble <span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text">$</span>
                                                                                        </div>
                                                                                        <input type="text" class="form-control" id="valmontocreditoclientes" name="valmontocreditoclientes" placeholder="Ingrese monto de cr&eacute;dito" onKeyUp="CalculoCuotaMensualHipotecas()" onkeypress="return (event.charCode <= 57)">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        ...
                                                                                        <input type="text" class="form-control" id="valplazocredito" name="valplazocredito" placeholder="Ingrese el n&uacute;mero de a&ntilde;os plazo" onKeyUp="CalculoCuotaMensualHipotecas()" onkeypress="return (event.charCode <= 57)" maxlength="2">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                        ...
                                                                                        <div class="card-body p-4">
                                                                                            <div class="media">
                                                                                                ...
                                                                                                <div class="media-body text-white">
                                                                                                    ...
                                                                                                    <small style="font-size: .95rem;"><strong>Monto final a financiar: $<span class="calculofinanciamientomaximo" id="calculofinanciamientomaximo"></span> USD.</strong></small><br>
                                                                                                    ...
                                                                                                    <ul class="list-group list-group-flush">
                                                                                                        ...
                                                                                                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Plazo :</span><strong id="plazo-credito" class="plazo-credito">0 a&ntilde;os</strong></li>
