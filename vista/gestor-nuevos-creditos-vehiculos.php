...
-->
        ...
        <head>
            ...
            <title>CashMan H.A. | Gestor Nuevos Pr&eacute;stamos Veh&iacute;culos</title>
            <!-- Favicon icon -->
                                ...
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <h3 class="text-center mb-4">Gestor de Pr&eacute;stamos Para Veh&iacute;culos</h3>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="text-center">
                                                        ...
                                                        <p>Asignar Nuevo Pr&eacute;stamo Para Veh&iacute;culos</p>
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn light btn-secondary" data-toggle="modal" data-target="#prestamospersonales">Requisitos Pr&eacute;stamos Para Veh&iacute;culos</button>
                                                        <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <h4 class="text-primary mb-4">Pr&eacute;stamos Para Veh&iacute;culos</h4>
                                                                            ...
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-tag"></i> Ingreso m&iacute;nimo: $700.00</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Tasa de inter&eacute;s desde el 10.00% mensual</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&aacute;ximo a financiar $100,000 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Plazo m&aacute;ximo 90 meses</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                            <ul class="timeline">
                                                                                <li>
                                                                                    ...
                                                                                    <a class="timeline-panel text-muted" href="#">
                                                                                        ...
                                                                                        <h6 class="mb-0"><i class="ti-tag"></i> Ingreso m&iacute;nimo: $1,000.00</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Tasa de inter&eacute;s desde el 17.00% mensual</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Monto m&aacute;ximo a financiar $200,000 USD</h6>
                                                                                        <h6 class="mb-0"><i class="ti-back-right"></i> Plazo m&aacute;ximo 90 meses</h6>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        <p style="color: #f00;">Nota: Por pol&iacute;ticas de esta empresa, solamente se otorgar&aacute;n pr&eacute;stamos a veh&iacute;culos nuevos. <strong>La cuota ya incluye seguro de deuda y GPS.</strong></p>
                                                                    </div>
                                    ...
                                    */
                                                        ...
                                                        ?>
                                                            <div class="col-xl-12">
                                                                <form data-id="<?php echo $Gestiones->getIdUsuarios(); ?>" id="ingreso-datos-credito-clientes" class="validacion-registro-credito-vehiculos" name="formulariocreditosclientes" method="post" autocomplete="off" enctype="multipart/form-data" onKeyUp="ConsultarRequisitosPrestamosVehiculos()">
                                                                    ...
                                                                    ';
                                                                        ...
                                                                        <div class="col-lg-12 mb-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    ...
                                                                                    <input type="range" class="form-control" value="20" min="10" max="60" autocomplete="off" id="rangointereses" name="rangointereses" onKeyUp="CalculoCuotaMensual()" step="0.05">
                                                                        ...
                                                                        <div class="col-lg-6 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="text-label">Valor de Veh&iacute;culo <span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text">$</span>
                                                                                        </div>
                                                                                        <input type="text" class="form-control" id="valmontocreditoclientes" name="valmontocreditoclientes" placeholder="Ingrese el valor del veh&iacute;culo" onKeyUp="CalculoCuotaMensual()" onkeypress="return (event.charCode <= 57)">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        ...
                                                                                        <textarea class="form-control" placeholder="Ingrese las observaciones de este cr&eacute;dito." id="valobservaciones" name="valobservaciones" rows="5"></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                            ...
                                                                                            <div class="media">
                                                                                                ...
                                                                                                <div class="media-body text-white">
                                                                                                    ...
                                                                                                    <ul class="list-group list-group-flush">
                                                                                                        ...
                                                                                                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Servicio GPS : </span><span><strong>$</strong><strong id="serviciogps" class="serviciogps"></strong><strong> USD</strong></span> </li>
                                                                                                    </ul><br>
    ...
    ***********************************-->
                            ...
                            <script src="<?php echo $UrlGlobal; ?>vista/js/alerta-registro-nuevos-prestamos-clientes-vehiculos.js"></script>
